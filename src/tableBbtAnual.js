// tableBbtAnual.js
// - Carga datos statsYearYYYY.js (BBT España) y unifica filas por año
// - Filtros: NAF, Entrenador, Año, CCAA, WinRatio, Partidos
// - Calcula rankYear (global por año) y rankCcaa (por CCAA dentro del año)
// - Ordena por botones como en Streaks (con flechas ▲/▼ y toggle)
// - Pagina a 25 resultados por página
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let sortState = { key: null, dir: "desc" }; // por defecto, sin botón => rankYear asc
  ...
  function setSort(key) {
    ...
    if (sortState.key === key) {
      ...
      sortState.key = key;
      sortState.dir = "desc"; // primera pulsación descendente (como en Streaks)
    }
  ...
  function initializeTable() {
    ...
    // Unificar filas de todos los años (solo España si hay campo Country)
    Object.entries(yearData).forEach(([year, data]) => {
      data.forEach((item) => {
        ...
        allRows.push({
          ...
          winRatio: Number(item.winRatio || 0), // porcentaje numérico (0..100)
    ...
    // Listeners: reinician a página 1
  ...
  function applyFilters() {
    ...
    if (sortState.key) {
      ...
      // por defecto, posición general ascendente
