// tableRazasHistorico2025.js
// - Carga estadÃ­sticas por raza BB2025 (tournaments variantid = 15)
// - Usa archivos tipo "amazon2025.js" => const amazon2025 = [...];
// - Filtros: PaÃ­s, NAF, Entrenador, Raza, WinRatio, Partidos
// - Calcula globalRank (general) y countryRank (dentro del paÃ­s)
// - OrdenaciÃ³n por botones (globalRank, countryRank, tournaments, games, wr, rating)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // === IMPORTANTE: aquÃ­ cambiamos el nombre de la variable para BB2025 ===
  ...
  async function loadRaceData(raceName){
    ...
    if (typeof window[varName] !== 'undefined') {
      ...
      // eval como fallback (por si el bundle define la variable de otra forma)
      try {
  ...
  async function handleRaceChange(){
    ...
    for (const r of racesToLoad){
      ...
      // AÃ±adimos campo "race" con el nombre legible (Amazon, Orc, etc.)
